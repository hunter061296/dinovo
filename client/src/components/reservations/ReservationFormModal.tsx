...
import { useReservationDetailForm } from "./useReservationDetailForm";
import { ModalBackdrop, ModalCloseButton, ModalPanel } from "../Modal";
import { TagBadge } from "../TagBadge";

export type { ReservationFormValues } from "../../lib/reservations";
          ...
          {initial && (
            <div className="mb-4 grid grid-cols-4 gap-2 rounded-md border border-gray-200 bg-gray-50 p-3 text-center dark:border-gray-700 dark:bg-gray-900/40">
              <div>
                ...
                <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">{f.guestDetail?.visitCount ?? initial.guest.visitCount}</div>
              </div>
              <div>
              ...
              <div>
                ...
                <div className="text-sm font-semibold text-gray-900 dark:text-gray-100">{f.guestDetail?.noShowCount ?? initial.guest.noShowCount}</div>
              </div>
              <div className="col-span-4 mt-1 flex items-center justify-between border-t border-gray-200 pt-2 dark:border-gray-700">
                ...
                {f.notified ? (
                  ...
                  >
                    {f.notifying ? "Sending..." : "Message guest"}
                  </button>
                )}
              </div>
            </div>
