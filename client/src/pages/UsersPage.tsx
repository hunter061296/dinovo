  ...
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Create and manage Manager and Host accounts.</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-3 rounded-lg border border-gray-200 bg-white p-4 sm:grid-cols-2">
        {formError && <div className="col-span-full rounded-md bg-red-50 px-3 py-2 text-sm text-red-700">{formError}</div>}
      ...
      <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
        {isLoading && <div className="p-4 text-sm text-gray-500">Loading users...</div>}
        {isError && <div className="p-4 text-sm text-red-600">Failed to load users.</div>}
        {users && (
