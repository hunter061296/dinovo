  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-gray-500">Add walk-ins and seat them as tables open up.</p>
      </div>
      ...
      {isLoading && <div className="text-sm text-gray-500">Loading waitlist...</div>}
      {isError && <div className="text-sm text-red-600">Failed to load the waitlist.</div>}

      {entries && (
        <div className="overflow-hidden rounded-lg border border-gray-200 bg-white">
          {entries.length === 0 ? (
            <div className="p-6 text-center text-sm text-gray-400">No one is waiting right now.</div>
          ) : (
