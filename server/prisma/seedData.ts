...
export async function seedDatabase(prisma: PrismaClient) {
  ...
  const reservationDefs = [
    ...
    { guest: guests[2], party: 2, time: at(12, 30), table: tables[1], shift: lunch },
    {
      ...
      table: tables[7],
      shift: lunch,
      foodDrinkNote: "Peanut allergy — confirm with kitchen.",
    },
    ...
    { guest: guests[11], party: 4, time: at(18, 30), table: tables[6], shift: dinner },
    {
      ...
      shift: dinner,
      tags: ["Anniversary"],
      generalNote: "Celebrating their 10th anniversary — quiet table if possible.",
      seatingNote: "Requested a booth away from the kitchen.",
    },
    {
      guest: guests[13],
      party: 4,
      ...
      table: tables[11],
      shift: dinner,
      foodDrinkNote: "Gluten intolerant.",
    },
    {
      guest: guests[14],
      party: 10,
      ...
      shift: dinner,
      tags: ["Business"],
      offerNote: "Comped dessert course per manager approval.",
      excludeFromPacing: true,
    },
    ...
    reservationDefs.map((r, i) => {
      ...
      return prisma.reservation.create({
        data: {
          ...
          foodDrinkNote: r.foodDrinkNote,
          seatingNote: r.seatingNote,
          excludeFromPacing: r.excludeFromPacing,
